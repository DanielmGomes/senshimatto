...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="<?= base_url(); ?>restrict/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="<?= base_url(); ?>restrict/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
    <link href="<?= base_url(); ?>restrict/css/nprogress.css" rel="stylesheet">
    <!-- iCheck -->
    <link href="<?= base_url(); ?>restrict/css/green.css" rel="stylesheet">
    <!-- Datatables -->
    ...
    <!-- Custom Theme Style -->
    <link href="<?= base_url(); ?>restrict/css/custom.min.css" rel="stylesheet">
  </head>
  ...
  <body class="nav-md">
    ...
    <!-- jQuery -->
    <script src="<?= base_url(); ?>restrict/js/jquery.min.js"></script>
    <!-- Bootstrap -->
    <script src="<?= base_url(); ?>restrict/js/bootstrap.min.js"></script>
    <!-- FastClick -->
    <script src="<?= base_url(); ?>restrict/js/fastclick.js"></script>
    <!-- NProgress -->
    <script src="<?= base_url(); ?>restrict/js/nprogress.js"></script>
    <!-- iCheck -->
    <script src="<?= base_url(); ?>restrict/js/icheck.min.js"></script>
    <!-- Datatables -->
