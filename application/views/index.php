<section id="fh5co-home" data-section="home" style="background-image: url(<?php echo base_url('public/images/banner/banner01.jpg'); ?>); height: 800px;" data-stellar-background-ratio="0.5">
			...
			<div class="row">
				...
				<!--	
					<div class="box-services">
						<span><img src="<?php echo base_url(); ?>public/images/destaque/destaque01.jpg" alt=""></span>
					...
					<div class="box-services">
							<span><img src="<?php echo base_url(); ?>public/images/destaque/destaque02.jpg" alt=""></span>
						<div class="fh5co-post to-animate">
							<br>
				...
				<div class="col-md-3 text-center">
					<div class="box-services">
							<span><img src="<?php echo base_url(); ?>public/images/destaque/destaque09.jpg" alt=""></span>
						<div class="fh5co-post to-animate">
							<br>
					...
					<!--
					<div class="box-services">
							<span><img src="<?php echo base_url(); ?>public/images/destaque/destaque04.jpg" alt=""></span>
						<div class="fh5co-post to-animate">
							<br>
				...
				<div class="col-md-3 text-center">
					<div class="box-services">
							<span><img src="<?php echo base_url(); ?>public/images/destaque/destaque10.jpg" alt=""></span>
						<div class="fh5co-post to-animate">
							<br>
							<h3>Desafio BJJ</h3>
					...
					<!--
					<div class="box-services">
							<span><img src="<?php echo base_url(); ?>public/images/destaque/destaque06.jpg" alt=""></span>
						<div class="fh5co-post to-animate">
							<br>
				...
				<div class="col-md-3 text-center">
					<div class="box-services">
							<span><img src="<?php echo base_url(); ?>public/images/destaque/destaque07.jpg" alt=""></span>
						<div class="fh5co-post to-animate">
							<br>
					...
					<div class="box-services">
							<span><img src="<?php echo base_url(); ?>public/images/destaque/destaque08.jpg" alt=""></span>
						<div class="fh5co-post to-animate">
							<br>
			...
			<div class="row">
				 <div class="col-md-2 col-sm-3 col-xs-6 col-sm-offset-0 col-md-offset-1">
					<div class="partner-logo to-animate-2">
						<img src="<?php echo base_url(); ?>public/images/patrocinio/patrocinio01.jpg" alt="Partners" class="img-responsive">
					</div>
				 </div>
					<div class="col-md-2 col-sm-3 col-xs-6">
						<div class="partner-logo to-animate-2">
							<img src="<?php echo base_url(); ?>public/images/patrocinio/patrocinio02.jpg" alt="Partners" class="img-responsive">
					</div>
					</div>
					<div class="col-md-2 col-sm-3 col-xs-6">
						<div class="partner-logo to-animate-2">
							<img src="<?php echo base_url(); ?>public/images/patrocinio/patrocinio03.jpg" alt="Partners" class="img-responsive">
						</div>
					</div>
					<div class="col-md-2 col-sm-3 col-xs-6">
						<div class="partner-logo to-animate-2">
							<img src="<?php echo base_url(); ?>public/images/patrocinio/patrocinio04.jpg" alt="Partners" class="img-responsive">
						</div>
					</div>
					<div class="col-md-2 col-sm-12 col-xs-12">
						<div class="partner-logo to-animate-2">
							<img src="<?php echo base_url(); ?>public/images/patrocinio/patrocinio05.jpg" alt="Partners" class="img-responsive">
						</div>
					</div>
			</div>
		</div>
