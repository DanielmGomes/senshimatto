		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate"><span>Meus Dados</span></h2>
				</div>
			</div>

			<form class="form-horizontal form-label-left input_mask" action="<?php echo site_url('usuarios/edita_usuario'); ?>" method="POST">
				<input type="text" name="idUsuario" value="<?php echo $idUsuario; ?>" hidden>
				<div class="row">
					<div class="col-md-5 col-sm-6 col-xs-12 form-group">
						<label for="">Nome Completo</label>
						<input type="text" class="form-control" name="nome" maxlength="60" value="<?php echo $nome; ?>">
					</div>	
				...
				<div class="row">
					<div class="col-md-5 col-sm-6 col-xs-12 form-group">
						<label for="">CPF</label>
						<input type="text" class="cpf form-control" id="cpf" name="cpf" value="<?= $cpf; ?>">
					</div>	
				...
				<div class="row">
					<div class="col-md-5 col-sm-6 col-xs-12 form-group">
						...
						<input type="text" class="celular form-control" id="celular" name="whatsapp" value="<?= $whatsapp; ?>">		      
					</div>	
					...
					<div class="col-md-5 col-sm-6 col-xs-12 form-group">
						...
						<input type="email" class="form-control" name="email" maxlength="60" value="<?= $email; ?>">
					</div>			
				</div>
				...
				<div class="row">
					...
					<div class="col-md-5 col-sm-6 col-xs-12 form-group">
						...
						<input type="text" class="peso form-control" name="peso" id="peso" value="<?= $peso; ?>">
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-5 col-sm-6 col-xs-12 form-group">
						...
						<input type="text" class="form-control" name="usuario" maxlength="60" value="<?= $usuario; ?>">
					</div>	
