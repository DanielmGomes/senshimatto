<!DOCTYPE html>
	...
	<section id="fh5co-home" data-section="home" style="background-image: url(images/banner/banner01.jpg); height: 800px;" data-stellar-background-ratio="0.5">
				...
				<div class="row">
					<div class="col-md-3 text-center">
						<div class="box-services">
								<span><img src="images/destaque/destaque01.jpg" alt=""></span>
						...
						<div class="box-services">
								<span><img src="images/destaque/destaque02.jpg" alt=""></span>
							<div class="fh5co-post to-animate">
								<br>
					...
					<div class="col-md-3 text-center">
						<div class="box-services">
								<span><img src="images/destaque/destaque03.jpg" alt=""></span>
							<div class="fh5co-post to-animate">
								<br>
						...
						<div class="box-services">
								<span><img src="images/destaque/destaque04.jpg" alt=""></span>
							<div class="fh5co-post to-animate">
								<br>
					...
					<div class="col-md-3 text-center">
						<div class="box-services">
								<span><img src="images/destaque/destaque05.jpg" alt=""></span>
							<div class="fh5co-post to-animate">
								<br>
						...
						<div class="box-services">
								<span><img src="images/destaque/destaque06.jpg" alt=""></span>
							<div class="fh5co-post to-animate">
								<br>
					...
					<div class="col-md-3 text-center">
						<div class="box-services">
								<span><img src="images/destaque/destaque07.jpg" alt=""></span>
							<div class="fh5co-post to-animate">
								<br>
						...
						<div class="box-services">
								<span><img src="images/destaque/destaque08.jpg" alt=""></span>
							<div class="fh5co-post to-animate">
								<br>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="team-box text-center to-animate-2">
							<div class="user"><img class="img-reponsive" src="images/equipe/equipe01.png" alt="Roger Garfield"></div>
				...
				<div class="row">
					 <div class="col-md-2 col-sm-3 col-xs-6 col-sm-offset-0 col-md-offset-1">
					 	<div class="partner-logo to-animate-2">
					 		<img src="images/patrocinio/patrocinio01.jpg" alt="Partners" class="img-responsive">
					 	</div>
					 </div>
				    <div class="col-md-2 col-sm-3 col-xs-6">
				    	<div class="partner-logo to-animate-2">
				    		<img src="images/patrocinio/patrocinio02.jpg" alt="Partners" class="img-responsive">
						</div>
				    </div>
				    <div class="col-md-2 col-sm-3 col-xs-6">
				    	<div class="partner-logo to-animate-2">
				    		<img src="images/patrocinio/patrocinio03.jpg" alt="Partners" class="img-responsive">
				    	</div>
				    </div>
				    <div class="col-md-2 col-sm-3 col-xs-6">
				    	<div class="partner-logo to-animate-2">
				    		<img src="images/patrocinio/patrocinio04.jpg" alt="Partners" class="img-responsive">
				    	</div>
				    </div>
				    <div class="col-md-2 col-sm-12 col-xs-12">
				    	<div class="partner-logo to-animate-2">
				    		<img src="images/patrocinio/patrocinio05.jpg" alt="Partners" class="img-responsive">
				    	</div>
				    </div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 to-animate">
					...
					<p class="copy-right">&copy; 2019 Senshi Matto - Competições. <br>Todos os direitos são reservados. <br>
