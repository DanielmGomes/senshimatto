        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="painel.php" class="site_title"><span>Senshi Matto Admin</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-file-text"></i> Cadastros <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="pages/cadastros/competicoes.php">Competições</a></li>
                    </ul>
                  </li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Cadastrar Competição <small></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left input_mask" action="salvaCompeticao.php" method="POST" enctype="multipart/form-data">        
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" placeholder="Nome do Evento" name="nomeEvento" maxlength="60" required="">
                      ...
                      <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="celular form-control has-feedback-left" id="celular" placeholder="Whatsapp" name="whatsapp">
                      ...
                      <div class="form-group">
                        <div class="form-row">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                            <input type="text" class="cpf form-control has-feedback-left" id="cpf" placeholder="CPF do Responsável" name="cpfResponsavel">
                            <span class="fa fa-credit-card form-control-feedback left" aria-hidden="true"></span>
                          </div>
                        </div>
                      </div>        
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                          ...
                          <input type="date" class="form-control has-feedback-left" name="dataEvento" maxlength="30" required="">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <label> Cartaz da Competição</label>
                            <input type="file" name="foto" id="imagem" onchange="previewImagem()"><br><br>
                            <img name="teste" style="width: 150px; height: 150px;"><br><br>
                          <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
                          <script>
                            function previewImagem(){
                              var imagem = document.querySelector('input[name=foto]').files[0];
                              var preview = document.querySelector('img[name=teste]');
