    ...
    <div class="right_col" role="main">
        ...
        <div class="row tile_count">
          	...
          	<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            	<span class="count_top"><i class="fa fa-user"></i>Usuarios Masculino</span>
              	<div class="count green"></div>
              	<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>
          	</div>
          	<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            	<span class="count_top"><i class="fa fa-user"></i>Usuarios Feminino</span>
              	<div class="count"></div>
                    ...
                    <div class="x_content">
                    	  <div class="dashboard-widget-content">
                        		<ul class="quick-list">
                          			...
                          			<li><i class="fa fa-bar-chart"></i><a href="#">Auto Renewal</a> </li>
                          			<li><i class="fa fa-line-chart"></i><a href="#">Achievements</a></li>
                          			<li><i class="fa fa-area-chart"></i><a href="login/logout.php">Logout</a></li>
                        		</ul>
